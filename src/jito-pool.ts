...
export async function buyBundle() {
  ...
  const alt = new PublicKey(keyInfo.addressALT.toString());
  ...
  // extract token amount from keyInfo
  ...
  const solAmount = new BN(100_000 * keypairInfo.solAmount * LAMPORTS_PER_SOL);
